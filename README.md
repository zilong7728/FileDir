...
- **弹窗预览** — 点击文件弹出预览窗口；代码/脚本文件（py、js、md、json 等）自动渲染语法高亮，图片直接展示缩略图，Office 文件可跳转在线预览；点击遮罩或按 `Esc` 随时关闭，不影响文件列表浏览
...
- **代码高亮**：[Highlight.js](https://highlightjs.org/)（支持 Python、JavaScript、JSON、Markdown 等主流格式，CDN 引入零配置）
